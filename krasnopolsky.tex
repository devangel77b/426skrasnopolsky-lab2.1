...
% set PDF metadata
\hypersetup{%
pdftitle={Testing Newton's second law with cart and mass},
pdfauthor={Sharone Krasnopolsky, Timur Neyir, and Brady Gorelczenko},
}
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[RE,RO]{J S\&E \textbf{1}, 23--25 (2024)}
\fancyhead[LO]{Krasnopolsky et al.}
\fancyhead[LE]{Testing Newton's second law}
\fancyfoot[C]{\thepage}
\fancypagestyle{mytitlepage}{
\fancyhf{}
\fancyhead[C]{Journal of Science \& Engineering \textbf{1}, 23--25 (2024)}
\fancyfoot[C]{\thepage}
}
